...
# 0 0 0 1 1
    ...
    if len(left_centroids) > 0:
        for centroid in left_centroids:
            cv2.circle(mask3, centroid, 10, (255,0,0), 10)

    if len(right_centroids) > 0:
        for centroid in right_centroids:
            cv2.circle(mask3, centroid, 10, (0,255,0), 10)
